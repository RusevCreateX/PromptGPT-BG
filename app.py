...
При свалянето на Screenshot-ите от GA4, GSC и BWT се СВАЛЯТ на устройството, а не се копират и се именуват, както следва : 1,2,3,4,5 и т.н. Ако се добави информация за самото изображение, чатът структурира данните по-добре /1.Defaullt Channel Group GA4 main/
Когато чата пропусне изображение, може да се напише команда “Пропуснати са ХХХХ скрийншоти. Допълни доклада, добавяйки и тях”
Промпта е тестван на всички модели ChatGPT и досега най-успешен се оказва ChatGPT o1/uses advanced reasoning/
Промпта работи и еднакво добре на https://chatgpt.com/g/g-DGSpNhxyW-serpstat-seo-tool 
...
st.title("CustomGPT Quick Report CreateX")
